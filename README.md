...
- **Current package version:** see `tools/release/VERSION` (now `0.0.1-rc.4`)
...
{
  "dependencies": {
    "ai.themsp.unity.core": "https://github.com/ming-iman/unity-sdk-test.git?path=/upm#v0.0.1-rc.4",
    "ai.themsp.unity.adapter.nova": "https://github.com/ming-iman/unity-sdk-test.git?path=/packages/adapter-nova#v0.0.1-rc.4",
...
```json
"ai.themsp.unity.core": "file:../build/ai.themsp.unity.core-0.0.1-rc.4.tgz",
"ai.themsp.unity.adapter.nova": "file:../build/ai.themsp.unity.adapter.nova-0.0.1-rc.4.tgz"
```
