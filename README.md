...
- **Current package version:** see `tools/release/VERSION` (now `4.5.0-rc.0`)
...
{
  "dependencies": {
    "ai.themsp.unity.core": "https://github.com/ming-iman/unity-sdk-test.git?path=/upm#v4.5.0-rc.0",
    "ai.themsp.unity.adapter.nova": "https://github.com/ming-iman/unity-sdk-test.git?path=/packages/adapter-nova#v4.5.0-rc.0",
...
```json
"ai.themsp.unity.core": "file:../build/ai.themsp.unity.core-4.5.0-rc.0.tgz",
"ai.themsp.unity.adapter.nova": "file:../build/ai.themsp.unity.adapter.nova-4.5.0-rc.0.tgz"
```
